              ...
              : Column(
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Your current Home stays  (${productList.length} found)",
                        style: const TextStyle(
                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "${Config.SERVER}/assets/homestayimages/${productList[index].homestayId}.png",
...
//check permission,get location,get address return false if any problem.
  ...
  void _loadProducts() {
    ...
    http
        .get(
      Uri.parse(
          "${Config.SERVER}/php/loadregisteredhomestay.php?userid=${widget.user.id}"),
    )
        .then((response) {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsondata['status'] == 'success') {
          ...
          //extract data from jsondata array
          if (extractdata['homstay'] != null) {
            ...
            titlecenter =
                "No home stay Available 1"; //if no data returned show title center
            productList.clear();
          }
        } else {
          titlecenter = "No home stay Available2";
        }
      } else {
        titlecenter = "No home stay Available3"; //status code other than 200
